...
def test_musllinux_regex(test: str, result: str) -> None:
...
def test_musllinux_regex_wrong(test: str) -> None:
    """Test linux regex."""
...
def test_linux_regex(test: str) -> None:
    """Test linux regex."""
...
def test_linux_regex_wrong(test: str) -> None:
...
def test_working_abi_platform(abi: str, platform: str) -> None:
...
def test_fix_wheel_unmatch(tmp_path: Path) -> None:
    ...
    p.touch()
    p = tmp_path / "grpcio-1.31.0-cp39-cp39-musllinux_1_1_x86_64.whl"
    p.touch()
    ...
    assert wheel.fix_wheels_unmatch_requirements(tmp_path) == {"grpcio": "1.31.0"}
